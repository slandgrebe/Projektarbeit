...
namespace VisualizationLibraryTest
{
    ...
    public class Button
    {
        ...
        [TestMethod]
        public void Button_PositionXNegative() // Point positionieren den es nicht gibt
        {
            // Setup
            uint id = Utility.SetupButton();
            Library.position(id, 1, 2, 3);
        ...
        [TestMethod]
        public void Button_PositionYNegative() // Point positionieren den es nicht gibt
        {
            // Setup
            uint id = Utility.SetupButton();
            Library.position(id, 1, 2, 3);
        ...
        [TestMethod]
        public void Button_PositionZ() // Button hat keine z-Komponente
        {
            // Setup
            uint id = Utility.SetupButton();
            Library.position(id, 1, 2, 3);
        ...
        [TestMethod]
        public void Button_PositionZNegative() // Point positionieren den es nicht gibt
        {
            // Setup
            uint id = Utility.SetupButton();
            Library.position(id, 1, 2, 3);
